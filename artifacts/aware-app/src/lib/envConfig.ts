...
const DEFAULTS: EnvironmentConfig[] = [
  { id: 'qa_staging', label: 'QA / Staging', target: 'QA', network: 'staging', baseUrl: 'https://qa-staging.example.com', ips: [], active: true },
  { id: 'qa_prod', label: 'QA / Production', target: 'QA', network: 'production', baseUrl: 'https://qa.example.com', ips: [], active: true },
  { id: 'uat_staging', label: 'UAT / Staging', target: 'UAT', network: 'staging', baseUrl: 'https://uat-staging.example.com', ips: [], active: true },
  { id: 'uat_prod', label: 'UAT / Production', target: 'UAT', network: 'production', baseUrl: 'https://uat.example.com', ips: [], active: true },
  { id: 'prod_staging', label: 'PROD / Staging', target: 'PROD', network: 'staging', baseUrl: 'https://prod-staging.example.com', ips: [], active: true },
  { id: 'prod_prod', label: 'PROD / Production', target: 'PROD', network: 'production', baseUrl: 'https://www.example.com', ips: [], active: true },
];
...
export function getEnvByTierAndNetwork(tier: string, network: string): EnvironmentConfig | undefined {
