export function buildAnalyzeFailurePrompt(
  failures: Array<{ name: string; category: string; assertion: string }>,
): string {
...
export function buildFlakinessPrompt(
  flakyTests: Array<{ name: string; passRate: number; totalRuns: number }>,
): string {
