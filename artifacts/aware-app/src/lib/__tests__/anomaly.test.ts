...
const mockRuns: Run[] = [
  {
    id: "run_1", label: "Run 1", suiteId: "suite_1", envId: "qa_staging",
    env: "QA", network: "staging", status: "PASS", passPct: 98, failures: 1,
    duration: "5m", durationMs: 300000, started: "2025-06-01T00:00:00Z",
    build: "b1", rev: "r1",
  },
  {
    id: "run_2", label: "Run 2", suiteId: "suite_1", envId: "qa_staging",
    env: "QA", network: "staging", status: "PASS", passPct: 95, failures: 2,
    duration: "6m", durationMs: 360000, started: "2025-06-02T00:00:00Z",
    build: "b2", rev: "r2",
  },
  {
    id: "run_3", label: "Run 3", suiteId: "suite_1", envId: "qa_staging",
    env: "QA", network: "staging", status: "FAIL", passPct: 60, failures: 20,
    duration: "10m", durationMs: 600000, started: "2025-06-03T00:00:00Z",
    build: "b3", rev: "r3",
  },
  {
    id: "run_4", label: "Run 4", suiteId: "suite_1", envId: "qa_staging",
    env: "QA", network: "staging", status: "FAIL", passPct: 55, failures: 25,
    duration: "12m", durationMs: 720000, started: "2025-06-04T00:00:00Z",
    build: "b4", rev: "r4",
  },
  {
    id: "run_5", label: "Run 5", suiteId: "suite_1", envId: "qa_staging",
    env: "QA", network: "staging", status: "PASS", passPct: 97, failures: 2,
    duration: "5.5m", durationMs: 330000, started: "2025-06-05T00:00:00Z",
    build: "b5", rev: "r5",
  },
];

const emptyRuns: Run[] = [];
const tooFewRuns: Run[] = [
  mockRuns[0],
  mockRuns[1],
];
