    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 14 }}>
        ...
        <div style={{ textAlign: "center" }}>
          ...
          >
            LangGraph-powered AI · 8 analytics tools · live tables &amp; charts · Chrome AI / WebLLM
            / OpenAI
          </p>
        </div>
      </div>
        ...
        {[
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: "var(--proof-text)" }}>
                {label}
              </span>
            </div>
            <p
      ...
      <div style={{ maxWidth: 580, width: "100%" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 7, justifyContent: "center" }}>
          {[
            ...
            <button key={prompt} onClick={() => onSend(prompt)} className="copilot-quick-chip">
              {prompt}
            </button>
          ))}
        </div>
