        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <section style={{ padding: "20px 0" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8 }}>
              {[
                {
                  val: sched.summary.total,
                  lab: "Suites",
                  sub: `${sched.summary.scheduled} scheduled`,
                  col: "#2563eb",
                  icon: Calendar,
                },
                {
                  val: sched.summary.dispatched,
                  lab: "Dispatches",
                  sub: `${sched.summary.running} running`,
                  col: "#10b981",
                  icon: Play,
                },
                {
                ...
                return (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.borderColor = `${m.col}30`;
                      e.currentTarget.style.background = `linear-gradient(135deg, ${m.col}10, ${m.col}03)`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.borderColor = `${m.col}12`;
                      e.currentTarget.style.background = `linear-gradient(135deg, ${m.col}06, transparent)`;
                    }}
                  >
                    <div
                      style={{
                    ...
                    <div style={{ fontSize: 9, color: "var(--proof-text-muted)", marginTop: 4 }}>
                      {m.sub}
                    </div>
                  </div>
                );
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 10, color: "var(--proof-text-muted)" }}>
                      Last {Math.min(sched.recentDispatches.length, 6)} of{" "}
                      {sched.recentDispatches.length}
                    </div>
                  </div>
              ...
              <div>
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 10, color: "var(--proof-text-muted)" }}>
                      Most recent {Math.min(sorted.length, 6)}
                    </div>
                  </div>
                  <button
                  ...
                  {sorted.slice(0, 6).map((run) => (
                    <div
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.borderColor = "var(--proof-blue)30";
                      }}
                      onMouseLeave={(e) => {
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          {run.env} · {new Date(run.started).toLocaleString()}
                        </div>
                      </div>
                      <div style={{ textAlign: "right", flexShrink: 0 }}>
                        ...
                        {run.failures > 0 && (
                          <div style={{ fontSize: 9, color: "var(--proof-red)", fontWeight: 600 }}>
                            {run.failures}f
                          </div>
                        )}
                      </div>
          ...
          <section style={{ padding: "20px 0" }}>
            ...
            >
              ...
              >
                <div style={{ fontSize: 10, color: "var(--proof-text-muted)" }}>
                  {freq.totalRuns} runs · avg {freq.runsPerDay}/day · ~{freq.avgIntervalHours}h
                  between
                </div>
                {freq.gaps.length > 0 && (
                  <div
          ...
          >
            CI Pipeline · {sorted.length} runs · {sched.summary.total} suites ·{" "}
            {sched.summary.dispatched} dispatches · {freq.avgIntervalHours}h avg interval
          </div>
        </div>
      </div>
      {Toast}
