...
const FEATURES = [
  ...
  },
  {
    icon: TestTube,
    title: "Test Manager",
    desc: "Full CRUD, bulk import/export, AI generation",
    color: "#8b5cf6",
  },
  {
    icon: Layers,
  ...
  },
  {
    icon: Zap,
    title: "AI Copilot",
    desc: "OpenAI, WebLLM, Chrome AI with 5 skills",
    color: "#f59e0b",
  },
] as const;
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
            ...
            <div>
              ...
              >
                ...
                — CDN test observability. No backend. No setup. No sign-up.
              </p>
            </div>
          </div>
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          >
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                ...
                >
                  <Book size={13} style={{ color: "var(--proof-blue)" }} />
                </div>
                <span
                  style={{
                    fontSize: 14,
              ...
              >
                A browser-based dashboard that tracks Akamai CDN test health after every code
                change. Pass rates, regressions, and promotion readiness — across QA, UAT, and PROD
            ...
            <div style={{ position: "relative" }}>
              ...
              <div
                style={{
                  ...
                  bottom: 8,
                  width: 2,
                  background: "linear-gradient(180deg, #2563eb, #10b981, #8b5cf6, #f59e0b)",
                  borderRadius: 1,
                }}
              />
              {[
                {
                  step: "01",
                  title: "Code Change",
                  desc: "Push triggers automated test runs",
                  color: "#2563eb",
                },
                {
                  step: "02",
                  title: "Results Ingest",
                  desc: "Outcomes pushed in real-time",
                  color: "#10b981",
                },
                {
                  step: "03",
                  title: "Analysis",
                  desc: "Rates, regressions, trends computed",
                  color: "#8b5cf6",
                },
                {
                  step: "04",
                  title: "Decision",
                  desc: "Promote or block with confidence",
                  color: "#f59e0b",
                },
              ].map((s, i) => (
                <div
                  ...
                  style={{
                    ...
                    animation: `slide-up 0.3s ease-out ${0.15 + i * 0.1}s both`,
                  }}
                >
                  <div
                    style={{
            ...
            {[
              {
                ...
                label: "Total Runs",
                sub: `${freq.avgIntervalHours}h avg interval`,
                color: "#2563eb",
              ...
              },
              {
                ...
                sub: `${summary.sourceFiles} source files`,
                color: "#10b981",
                gradient: "linear-gradient(135deg, rgba(16,185,129,0.12), rgba(16,185,129,0.04))",
              },
              {
                icon: Layers,
                value: String(suiteCount),
                label: "Test Suites",
                sub: `${Object.keys(summary.byCategory).length} categories`,
                color: "#8b5cf6",
              ...
              },
              {
                ...
                sub: `${promoteCount} promotions · ${promoPct}% rate`,
                color: "#f59e0b",
        ...
        <section style={{ padding: "24px 0 28px" }}>
          ...
          <div style={{ display: "flex", gap: 6, height: 100, alignItems: "flex-end" }}>
            {Object.entries(summary.byCategory).map(([cat, count], i) => {
              ...
              const isBarHovered = hoveredCat === cat;
              return (
                <div
                  key={cat}
                  style={{
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: `linear-gradient(180deg, ${c}, color-mix(in srgb, ${c} 38%, transparent))`,
                      transition: "height 0.4s, box-shadow 0.2s",
                      cursor: "pointer",
                      boxShadow: isBarHovered
                        ? `0 0 30px color-mix(in srgb, ${c} 19%, transparent)`
                        : `0 0 20px color-mix(in srgb, ${c} 6%, transparent)`,
                    }}
                  />
                  <div
                    style={{
            ...
            {(ENV_SUMMARY.length > 0
              ...
              : ["QA", "UAT", "PROD"].map((label) => {
                  ...
                  return {
                    ...
                    color: envColors[label],
                  };
                })
            ).map((env) => {
              const isHovered = hoveredEnv === env.label;
              return (
                <div
                  key={env.label}
                  onMouseEnter={() => setHoveredEnv(env.label)}
                  onMouseLeave={() => setHoveredEnv(null)}
                  style={{
                    padding: "16px 18px",
                    borderRadius: 10,
                    background: "var(--proof-env-card)",
                    border: `1px solid color-mix(in srgb, ${env.color} ${isHovered ? 31 : 12}%, transparent)`,
                    position: "relative",
                    overflow: "hidden",
                    transition: "border-color 0.2s, box-shadow 0.2s",
                    boxShadow: isHovered
                      ? `0 0 30px color-mix(in srgb, ${env.color} 3%, transparent)`
                      : "none",
                  }}
                >
                  {/* decorative glow */}
                  <div
                    style={{
                      ...
                      height: 100,
                      borderRadius: "50%",
                      background: `radial-gradient(circle, color-mix(in srgb, ${env.color} 3%, transparent), transparent 70%)`,
                      pointerEvents: "none",
                    }}
                  />
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        animation: env.failures > 0 ? "pulseDot 1.5s ease-in-out infinite" : "none",
                      }}
                    />
                  </div>
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: "100%",
                          borderRadius: 2,
                          background: `linear-gradient(90deg, ${env.color}80, ${env.color})`,
                  ...
                  <div style={{ display: "flex", gap: 14, fontSize: 11, position: "relative" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
                      <TrendingUp
                        size={11}
                        style={{
                          color: env.trend >= 0 ? "var(--proof-green)" : "var(--proof-red)",
                        }}
                      />
                      <span
                        style={{
                    ...
                    {env.failures > 0 && (
                      <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
                        <span style={{ fontWeight: 600, color: "var(--proof-red)" }}>
                          {env.failures}
                        </span>
            ...
            {[
              {
                icon: Shield,
                title: "Deploy Gate",
                desc: "Block promotion if UAT pass rate drops below 95%",
                color: "#f97316",
              },
              {
                icon: GitCompare,
                title: "Diff Review",
                desc: "Compare two runs to spot regressions before they ship",
                color: "#10b981",
              },
              {
                icon: Activity,
                title: "Trend Watch",
                desc: "Monitor pass rates per env over time — catch drift early",
                color: "#2563eb",
              },
              {
                icon: Zap,
                title: "AI Debug",
                desc: "Ask the Copilot to explain a failed diff or generate new tests",
                color: "#f59e0b",
              },
              {
                icon: Globe,
                title: "Env Parity",
                desc: "Ensure consistent behavior across QA, UAT, and PROD",
                color: "#06b6d4",
              },
              {
                icon: Bug,
                title: "Test Ops",
                desc: `Manage ${testCount}+ auto-discovered tests across ${suiteCount} suites`,
                color: "#ef4444",
              },
            ].map((uc) => {
              const I = uc.icon;
        ...
        <section style={{ padding: "24px 0 28px", position: "relative" }}>
          ...
          >
            <defs>
              ...
              >
                <path
                  d="M28 2L54 18v32L28 66 2 50V18L28 2z"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="0.8"
                />
                <path
                  d="M28 34L54 50v32L28 82 2 66V34L28 34z"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="0.8"
                />
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {[
              ...
              },
              {
                icon: Zap,
                name: "Vite 7",
                desc: "Instant HMR, optimized builds",
                color: "#8b5cf6",
              },
              {
                icon: Server,
                name: "TypeScript 5.9",
                desc: "Full type safety, 16 pages",
                color: "#2563eb",
              },
              ...
              { icon: PieChart, name: "Recharts", desc: "Responsive charts", color: "#f59e0b" },
              {
                icon: Lock,
                name: "localStorage",
                desc: "Client-only persistence",
                color: "#f97316",
              },
              {
                icon: Cloud,
                name: "GitHub Actions",
                desc: "CI/CD + scheduler",
                color: "#ef4444",
              },
              {
                icon: Route,
                name: "Lucide Icons",
                desc: "Consistent icon system",
                color: "#06b6d4",
              },
            ].map((t) => {
              const I = t.icon;
              return (
                ...
                >
                  ...
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 700, color: "var(--proof-text)" }}>
                      {t.name}
                    </div>
          ...
          >
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{ fontSize: 12, color: "var(--proof-text-secondary)" }}>
                Start with the Dashboard or dive into the full test registry.
              </div>
            </div>
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            style={{ color: "var(--proof-blue)", textDecoration: "none" }}
          >
            GitHub
          </a>
        </div>
