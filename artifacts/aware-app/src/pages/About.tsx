            ...
            >
              <div>
                ...
                >
                  ...
                  change. Pass rates, regressions, and promotion readiness — across QA, UAT, and
                  PROD — entirely in your browser.
                </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div
                          style={{ fontSize: 9, color: "var(--proof-text-muted)", marginTop: 1 }}
                        >
                          {s.sub}
                        </div>
                      </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {(ENV_SUMMARY.length > 0
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = `${env.color}50`;
                    e.currentTarget.style.boxShadow = `0 0 30px ${env.color}08`;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = `${env.color}20`;
                    e.currentTarget.style.boxShadow = "none";
                  }}
                >
                  {/* decorative glow */}
                  <div
                    style={{
                      ...
                      height: 100,
                      borderRadius: "50%",
                      background: `radial-gradient(circle, ${env.color}08, transparent 70%)`,
                      pointerEvents: "none",
                    }}
                  />
