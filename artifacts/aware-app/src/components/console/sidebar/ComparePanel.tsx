  ...
  return (
    <div
      ...
      style={{
        padding: "5px 7px",
        borderRadius: 3,
        background: isActive ? "var(--proof-hover)" : "var(--proof-hover-light)",
        display: "flex",
        flexDirection: "column",
        gap: 1,
        cursor: "pointer",
        transition: "background 0.1s",
        border: isActive ? `1px solid ${stat.color}40` : "1px solid transparent",
      }}
      onMouseEnter={(e) => {
      ...
      {baselineRun && candidateRun && (
        <div style={{ padding: "6px 10px", borderBottom: "1px solid var(--proof-border)" }}>
          ...
          >
            ...
            >
              <span style={{ fontWeight: 600, color: "var(--proof-text-secondary)" }}>
                Baseline
              </span>
              <span style={{ fontFamily: "var(--font-mono)", color: "var(--proof-text)" }}>
                {baselineRun.envId}/{baselineRun.env}
              </span>
              <span style={{ fontFamily: "var(--font-mono)", color: "var(--proof-text-muted)" }}>
            ...
            >
              <span
                style={{ fontFamily: "var(--font-mono)", color: "var(--proof-text-secondary)" }}
              >
                {diffs.length} tests
              </span>
