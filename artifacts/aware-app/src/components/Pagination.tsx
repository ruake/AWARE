...
export function Pagination({
  ...
  return (
    ...
    >
      <span className="text-xs text-gcp-text-muted tabular-nums">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          disabled={page === 1}
          className="px-2.5 py-1.5 text-xs text-gcp-text-secondary hover:text-gcp-text disabled:opacity-30 disabled:cursor-not-allowed rounded-md hover:bg-gcp-elevated/60 transition-all duration-150"
        >
          «
        </button>
        <button
