...
export function TestManagerSidePanel({
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, lineHeight: 1.5, marginBottom: 6 }}>
            {tc.name}
          </div>
          <p style={{ fontSize: 12, color: "var(--proof-text-secondary)", lineHeight: 1.5 }}>
            {tc.description}
          </p>
        </div>
            ...
            >
              ...
              {k === "Script" && tc.scriptPath ? (
                ...
                <span
                  style={{
                    fontFamily:
                      k === "Script" || k === "Expected Status" ? "var(--font-mono)" : undefined,
                    fontSize: 11,
                  }}
                >
                  {v}
        ...
        <div>
          ...
          {editingDoc ? (
            ...
            >
              {tc.documentation || "No documentation"}
            </div>
          )}
        </div>
        <div>
            ...
            {changelog.slice(0, 5).map((e) => (
              <div key={e.version} style={{ display: "flex", gap: 8, fontSize: 12 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 11, color: "var(--proof-text-secondary)", margin: 0 }}>
        ...
        <div>
          ...
          >
            ...
            Test Flow Diagram
            <span
              style={{ marginLeft: "auto", fontSize: 10, color: "var(--proof-text-secondary)" }}
            >
              {showFlow ? "Hide" : "Show"}
            </span>
          </button>
