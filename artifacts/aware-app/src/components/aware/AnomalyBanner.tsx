  ...
  return (
    ...
    >
      <div style={{
        ...
        <AlertTriangle size={16} style={{ color: isCritical ? "var(--proof-red-bright)" : "var(--proof-yellow-bright)" }} />
      </div>
      <div style={{ flex: 1 }}>
        <div style={{ fontSize: 13, fontWeight: 600, color: isCritical ? "var(--proof-red-bright)" : "var(--proof-yellow-bright)" }}>
          {isCritical
      ...
      <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
        <button onClick={onInvestigate} className="proof-button-primary proof-button-sm"
          style={{ color: "#fff" }}>
          Investigate →
        </button>
      </div>
