...
export function generateGitHubActionsYaml(suite: { id: string; name: string; schedule: string | null; config: { target: string; environment: string; parallelism: number } }): string {
