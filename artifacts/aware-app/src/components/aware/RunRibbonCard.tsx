...
export function RunRibbonCard({ label, run, nextDue, icon, accent, onClick, index }: RunRibbonCardProps) {
  ...
  const c = run
    ? run.passPct >= 95 ? "var(--proof-green)" : run.passPct >= 80 ? "var(--proof-yellow)" : "var(--proof-red)"
