...
function formatCell(value: string | number | null, col: TableColumn, isMax: boolean, isMin: boolean): React.ReactNode {
  if (value === null || value === undefined) return <span style={{ color: "var(--proof-text-muted)" }}>—</span>;

  const highlight = isMax ? "#34d399" : isMin ? "#f87171" : undefined;
  const highlightBg = isMax ? "rgba(52,211,153,0.08)" : isMin ? "rgba(248,113,113,0.08)" : undefined;
    ...
    <div style={{
      ...
      <div style={{ overflowX: "auto" }}>
        <table style={{
          ...
          fontSize: 11.5, tableLayout: "auto",
        }}>
          <thead>
              ...
              {table.columns.map(col => (
                <th
                  ...
                  style={{
                    ...
                    color: sortKey === col.key ? "var(--proof-blue-bright)" : "var(--proof-text-muted)",
      ...
      <div style={{
        ...
        fontSize: 9.5, color: "var(--proof-text-muted)",
      }}>
