...
- Name: dashboard.spec.ts >> Dashboard >> promotion gate status bar shows UAT threshold info
- Location: e2e/dashboard.spec.ts:54:3
...
Locator: getByText(/95%/)
Expected: visible
Error: strict mode violation: getByText(/95%/) resolved to 5 elements:
    1) <div data-component-name="div" class="text-3xl font-bold text-emerald-600 dark:text-emerald-400" data-replit-metadata="artifacts/aware/src/pages/Dashboard.tsx:144:14">95%</div> aka locator('div').filter({ hasText: /^95%$/ })
    2) <span data-component-name="span" class="text-2xl font-bold" data-replit-metadata="artifacts/aware/src/pages/Dashboard.tsx:196:20">95%</span> aka getByText('%').nth(3)
    3) <span data-component-name="span" class="font-medium text-emerald-500" data-replit-metadata="artifacts/aware/src/pages/Dashboard.tsx:209:22">95%</span> aka getByText('%').nth(4)
    4) <tspan x="913" dy="0.71em">95% gate</tspan> aka getByText('% gate')
    5) <div data-component-name="div" data-replit-metadata="artifacts/aware/src/components/layout/PropertyStatusBar.tsx:22:6">UAT Pass Rate: 96.2% (Threshold: 95%)</div> aka getByText('UAT Pass Rate: 96.2% (')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText(/95%/)
